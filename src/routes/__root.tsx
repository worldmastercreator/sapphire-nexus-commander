  ...
  head: () => ({
    meta: [
      ...
      { title: "Developer Manager Console | Software Vala" },
      {
        name: "description",
        content:
          "Secure Developer Manager console for delivery governance, developer management and audit logging.",
      },
      { name: "author", content: "Software Vala" },
      { property: "og:title", content: "Developer Manager Console" },
      {
        property: "og:description",
        content: "Delivery governance and developer management in one secure console.",
      },
